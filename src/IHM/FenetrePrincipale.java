...
public class FenetrePrincipale extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnuCliFP = new javax.swing.JMenu();
        mnuFPNC = new javax.swing.JMenuItem();
        mnuProsFP = new javax.swing.JMenu();
        mnuFPPros = new javax.swing.JMenuItem();
        mnRepFP = new javax.swing.JMenu();
        mnuFPRep = new javax.swing.JMenuItem();
        mnuCatalogueFP = new javax.swing.JMenu();
        jMenuItem11 = new javax.swing.JMenuItem();
        jMenuItem12 = new javax.swing.JMenuItem();
        jMenuItem13 = new javax.swing.JMenuItem();
        jMenuItem14 = new javax.swing.JMenuItem();
        mnuCloseFP = new javax.swing.JMenu();
        ...
        mnuCliFP.setText("Client");

        mnuFPNC.setText("Interface Client");
        mnuFPNC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuFPNCActionPerformed(evt);
            }
        });
        mnuCliFP.add(mnuFPNC);

        mnuBarFP.add(mnuCliFP);

        mnuProsFP.setText("Prospect");

        mnuFPPros.setText("Fenetre Prospect");
        mnuFPPros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuFPProsActionPerformed(evt);
            }
        });
        mnuProsFP.add(mnuFPPros);

        mnuBarFP.add(mnuProsFP);

        mnRepFP.setText("Représentant");

        mnuFPRep.setText("Fenetre Représentant");
        mnRepFP.add(mnuFPRep);

        mnuBarFP.add(mnRepFP);
        ...
        mnuCloseFP.setText("Fermer");
        mnuCloseFP.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mnuCloseFPMouseClicked(evt);
            }
        });
        mnuBarFP.add(mnuCloseFP);
...
/**
 * Permet de fermer définitivement le logiciel
 * @param evt 
 */
    private void mnuCloseFPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mnuCloseFPMouseClicked
        System.exit(0);
    }//GEN-LAST:event_mnuCloseFPMouseClicked

    /**
     * Permet de lancer la fenetre PanClient et de cacher la fenetre principale
     * depuis la barre de menus
     * @param evt 
     */
    private void mnuFPNCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuFPNCActionPerformed
        // TODO add your handling code here:
        FenetrePrincipale.this.dispose();
        PanClient panCli = new PanClient(new javax.swing.JDialog(),true);
        panCli.annu_champsNC();
        for(int i = 0; i<c.size();i++){
            panCli.txtNumCliNC.setText(String.valueOf(c.get(i).getNumCli()+1));
        }
        panCli.setVisible(true);
    }//GEN-LAST:event_mnuFPNCActionPerformed
    
    private void mnuFPProsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuFPProsActionPerformed
        // TODO add your handling code here:
        this.dispose();
        PanProspect panPro = new PanProspect(new javax.swing.JDialog(),true);
        panPro.annu_champsPC();
        panPro.setVisible(true);
    }//GEN-LAST:event_mnuFPProsActionPerformed
    ...
    /**
     * Permet de lancer la fenetre PanClient et de cacher la fenetre principale
     * depuis le bouton Client sur le coté Droit
     * @param evt 
     */
    ...
    private javax.swing.JMenu mnRepFP;
    private javax.swing.JMenuBar mnuBarFP;
    private javax.swing.JMenu mnuCatalogueFP;
    private javax.swing.JMenu mnuCliFP;
    private javax.swing.JMenu mnuCloseFP;
    private javax.swing.JMenuItem mnuFPNC;
    private javax.swing.JMenuItem mnuFPPros;
    private javax.swing.JMenuItem mnuFPRep;
    private javax.swing.JMenu mnuProsFP;
