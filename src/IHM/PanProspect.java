...
import Entites.*;
import Traitements.*;
import static Traitements.Bdds.ecrireBdd;
...
public class PanProspect extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtEnseignePC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtEnseignePCActionPerformed(evt);
            }
        });
        jPanAdresseNewCli.add(txtEnseignePC);
        txtEnseignePC.setBounds(90, 40, 150, 30);

        txtSiretPC.setText("Siret");
        txtSiretPC.setEnabled(false);
        jPanAdresseNewCli.add(txtSiretPC);
        txtSiretPC.setBounds(370, 40, 100, 30);
        ...
        cboVoiePC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboVoiePCActionPerformed(evt);
            }
        });
        jPanAdresseNewCli.add(cboVoiePC);
        cboVoiePC.setBounds(200, 80, 65, 30);
        ...
        lblVillePC.setBounds(20, 160, 30, 30);
        ...
        lblCpPC.setBounds(290, 160, 81, 30);

        txtCpPC.setText("CP");
        txtCpPC.setEnabled(false);
        txtCpPC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCpPCActionPerformed(evt);
            }
        });
    ...
    private void btnAjouterPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAjouterPCActionPerformed
        // TODO add your handling code here:
        //reference à l'action performed du bouton action, cas C
        fct='C';
        init_champsPC();
    ...
    private void btnModifierPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifierPCActionPerformed
        // TODO add your handling code here:
        //reference à l'action performed du bouton action, cas M
        fct = 'M';
    ...
    private void btnSupprimerPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupprimerPCActionPerformed
        // TODO add your handling code here:
        //reference à l'action performed du bouton action, cas S
        fct ='S';
        lblEnseRechPC.setVisible(true);
        txtEnsRechPC.setVisible(true);
        btnEnsRechPC.setVisible(true); 
    ...
    private void btnActionPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActionPCActionPerformed
        ...
        switch(fct){
            //créer un prospect
            case 'C':
                //objet pro qui recupére mes texte fiel, sert dans Bdds
            Prospect pros = new Prospect(Integer.parseInt(txtCpPC.getText()),Integer.parseInt(txtTelPC.getText()),Integer.parseInt(txtSiretPC.getText()),Integer.parseInt(txtNumRuePC.getText()),Integer.parseInt(txtCedexPC.getText()),txtEnseignePC.getText(),txtRuePC.getText(),txtVillePC.getText(),cboPaysPC.getSelectedItem().toString(),txtMailPC.getText(),txtCompAdPC.getText(),cboVoiePC.getSelectedItem().toString(),txtLastVisitePC.getText());
                p.add(pros);
                try {
                    ecrireBdd('P', "prospect",pros);
    ...
    private void txtEnseignePCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtEnseignePCActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtEnseignePCActionPerformed

    private void cboVoiePCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboVoiePCActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboVoiePCActionPerformed

    private void txtCpPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCpPCActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCpPCActionPerformed
